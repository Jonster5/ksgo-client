import type { DisplayObject, DisplayProperties, DimensionProperties } from '@lib/display';
...
export class Stage implements DisplayProperties, DimensionProperties {
    ...
    constructor(width: number, height: number, x?: number, y?: number, rotation?: number) {
        this.w = width;
        this.h = height;
