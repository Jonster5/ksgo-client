...
import type { ShipThruster } from '../thruster';
import type { ShipLaser } from '../weapon';
import type { Stage } from '@lib/api/stage';
...
export interface Player {
    ...
    updateGravity(stars: Array<Star>, planets: Array<Planet>, asteroids: Array<Asteroid>): void;
}
