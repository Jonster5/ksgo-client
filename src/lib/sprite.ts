...
export class Sprite implements DisplayProperties, FrameProperties, DimensionProperties {
    ...
    constructor(frames: HTMLImageElement[], width: number, height: number, x?: number, y?: number) {
        this.frames = frames;
